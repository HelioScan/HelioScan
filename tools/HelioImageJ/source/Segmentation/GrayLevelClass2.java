...
public class GrayLevelClass2 {
    private static float[] probabilityHistogram;
    public static boolean probabilityHistogramDone;
    public static int N;
public static int intMax =65536 ;
    private int index;
    private float omega;
    private float mu;

    public GrayLevelClass2(ShortProcessor img, boolean first) {
	if(!probabilityHistogramDone) {
	    int[] histogram = img.getHistogram();
	
	//IJ.showMessage(""+intMax);
	    probabilityHistogram = new float[intMax ];
